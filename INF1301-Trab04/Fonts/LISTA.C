...
/***************************************************************************
*
*  Função: LIS  &Alterar o conteudo do elemento corrente da lista
*  ****/

LIS_tpCondRet LIS_AlterarConteudoCorrente ( LIS_tppLista pLista, void * pConteudo )
{
	/* Tratar lista inexistente */

	void * conteudo = pConteudo;
	...
	pLista->pElemCorr->pConteudo = conteudo;

	return LIS_CondRetOK;


} /* Fim função: LIS  &Alterar o conteudo do elemento corrente da lista */
