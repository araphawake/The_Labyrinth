...
*	  8.00	  ramsc	30/nov/2014	Atualização da documentação e inclusão de comandos de teste DETURPAR_GRF_CMD, VERIFICAR_GRF_CMD, ELIMINAR_LIMITES, LIMITAR_MEMORIA.
...
*									- Recebe o número inteiro do grafo, o número que identifica a deturpação e a condição de retorno esperada.
*	  =verificar					indexFocoGrafo	resposta	GRF_CondRetEsperada
*									- Verifica se há erros estruturais no grafo.
*									- Recebe o número inteiro do grado, o número que representa a quantidade de erros esperada e inteiro da condição de retorno esperada.
*	  =eliminarlimites				- Eliminam limites fictícios de memória alocada.
*	  =limitarmemoria				- Criam limites artificiais (simulados) de memória.
*
***********************************************************************/
